...
const MANAGER_NAV = [
  ...
  // ... add other manager nav items as needed ...
];
...
// ...existing code...
  ...
  export default function Sidebar({ onNavigate, isMobile }) {
    ...
    return (
      <aside className={`flex flex-col w-80 bg-white border-r border-gray-100 min-h-screen ${isMobile ? '' : 'hidden md:flex'}`}>
        {isMobile && onNavigate && (
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
          ...
          <span className="font-bold text-gray-900 text-lg leading-tight">
            FinOps<br />
            <span className="text-indigo-600 text-sm font-semibold">Tracker</span>
          </span>
        </div>
