        ...
        <>
         ...
         {ELEVATED.includes(user?.role) && (
          <div className="bg-white rounded-xl border pt-5 mt-4">
            <div className="flex flex-wrap items-end gap-4 mb-4 px-5"> {/* Added items-end to line up button layout */}
              <div>
              ...
              {(selectedTeam !== '' || selectedEmployee !== '') && (
                <button
                  ...
                  className="text-sm font-semibold text-red-500 hover:text-red-700 transition-colors h-[30px] flex items-center"
                >
                  Clear Filters
                </button>
              )}
