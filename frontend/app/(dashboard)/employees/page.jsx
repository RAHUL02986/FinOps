...
export default function EmployeesPage() {
  ...
  // 👇 ADDED THIS TO TRACK THE OPEN DROPDOWN GLOBALLY ACROSS ROWS
                      ...
                      <tr key={emp._id} className="border-t hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-right">
                          <EmployeeActionsDropdown
                            employee={emp}
                            // 👇 LINK DROPDOWN STATE LOGIC TO THE PARENT WRAPPER
                            isOpen={activeDropdownId === emp._id}
                            setIsOpen={(openState) => setActiveDropdownId(openState ? emp._id : null)}
