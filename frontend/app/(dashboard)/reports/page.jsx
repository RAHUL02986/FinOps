               ...
               <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie 
                    ...
                    cy="45%" 
                    outerRadius={80} 
                    // FIX 1: Turn off outer line labels to eliminate text overlap
                    label={false} 
                  >
                    {combinedCategoryData.map((entry, i) => (
                      <Cell key={i} fill={entry.color} />
                    ))}
                  </Pie>
                  {/* FIX 2: Add a clean Legend at the bottom to identify the categories */}
                  <Legend 
                    layout="horizontal" 
                    ...
                    formatter={(value, entry) => {
                      ...
                      return `${payload.type}: ${value} (${payload.percentage}%)`;
                    }}
                  />
